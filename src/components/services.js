    ...
    <div>
      <div className={styles.mainContainer}>
        ...
        <div className={styles.mainDiv}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>Electrician</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>Janitor work</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>labour work</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>Maid Work</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>AC technician</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>home painting</h1>
            {/* <p className={styles.divContent}>
          ...
          <div className={styles.element}>
            <h1 className={styles.divHeading}>Carpenter job</h1>
            {/* <p className={styles.divContent}>
            ...
            <img className={styles.falticonimg} src="/carpenter.png" />
          </div>
        </div>
      </div>
    </div>
